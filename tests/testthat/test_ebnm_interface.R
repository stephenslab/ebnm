...
test_that("'ebnm' calls give same results as 'ebnm_point_normal' or 'ebnm_point_laplace' calls",{
  ...
  ### test point_normal
  # fix nothing
  ebnm.res1 = ebnm(x, s, "point_normal", g = NULL, fix_mu = FALSE)
  ebnm.pn.res1 = ebnm_point_normal(x, s, g = NULL, fix_mu = FALSE)
  expect_equal(ebnm.res1, ebnm.pn.res1)
  # fix pi0
  ebnm.res2 = ebnm(x, s, "point_normal", g = list(pi0 = .2), fix_pi0 = TRUE,
                   fix_mu = FALSE)
  ebnm.pn.res2 = ebnm_point_normal(x, s, g = list(pi0 = .2), fix_pi0 = TRUE,
                                   fix_mu = FALSE)
  expect_equal(ebnm.res2, ebnm.pn.res2)
  # fix mu
  ebnm.res3 = ebnm(x, s, "point_normal")
  ebnm.pn.res3 = ebnm_point_normal(x, s)
  expect_equal(ebnm.res3, ebnm.pn.res3)
  # fix both
  ebnm.res4 = ebnm(x, s, "point_normal", g = list(pi0 = .2, mu = 0), fix_pi0 = TRUE, fix_mu = TRUE)
  ebnm.pn.res4 = ebnm_point_normal(x, s, g = list(pi0 = .2, mu = 0), fix_pi0 = TRUE, fix_mu = TRUE)
