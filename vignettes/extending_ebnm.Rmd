...
EBNM-solver functions. This function includes extra steps to check
that the input arguments are valid and to initialize the parameters if
an initialization isn't provided by the user.
