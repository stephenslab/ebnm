...
"shrink" the estimates toward the shared prior. This is one of the key
ideas underlying empirical Bayes.
...
With the normal prior, the "shrunken" estimates are better for smaller
$u_i$ values but worse for the larger values because they are shrunk
toward the common mean (near 2). Still, the shrunken estimates to
improve the *overall* estimation error (the "mean-squared error"):
...
```{r plot-mse-2, fig.height=3.5, fig.width=3.5, eval=FALSE}
mse_shrink_pn <- (y - u)^2
print(round(digits = 4,
